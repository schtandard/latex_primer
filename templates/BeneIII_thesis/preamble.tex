...
% {fontenc} should always be set to [T1].
% {lmodern} provides the Latin Modern font, a scalable version of Computer Modern.
% The {textcomp} package provides some glyphs missing by default, notably \textminus and \textmu.
% \input{glyphtounicode}\pdfgentounicode=1 makes ligatures copy-pasteable.
...
\makeatletter
  ...
  \let\@delsym\partial
  \def\@Difsym{{\mathrm D}}
  \def\@DifFeynsym{{\mathcal D}}
  \let\@bndrysym\partial
\makeatother
