...
\begin{itemize}
  ...
  \item Wird das Optionale Argument von \texttt{\string\caption} verwendet, so wird es als Titel der Fließumgebung fett gesetzt.
    (Wie immer wird es weiterhin für das Abbildungsverzeichnis verwendet.)
\end{itemize}
